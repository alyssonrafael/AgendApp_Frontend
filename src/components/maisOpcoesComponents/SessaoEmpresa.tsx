...
export default function SessaoEmpresa() {
  ...
  return (
    <View style={{ paddingHorizontal: 10 }}>
      <ThemedOptionItem
        ...
        text="Ver perfil"
        onPress={() => {
          router.push("/(telasEmpresas)/(maisOpcoes)/perfil");
        }}
      />
      <ThemedOptionItem
        ...
        text="Editar Perfil"
        onPress={() => {
          router.push("/(telasEmpresas)/(maisOpcoes)/editarPerfil");
        }}
      />
      <ThemedOptionItem
        ...
        text="Relatórios"
        onPress={() => {
          router.push("/(telasEmpresas)/(maisOpcoes)/relatorios");
        }}
      />
      <ThemedOptionItem
